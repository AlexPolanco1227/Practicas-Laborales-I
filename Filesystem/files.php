...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-danger btn-sm" id="new_folder"><i class="fa fa-plus"></i> Nueva Carpeta</button>
			<button class="btn btn-danger btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Subir Archivo</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
